...
type VK_auth = typeof import('./pages/VK_auth.js');
type GMail_auth = typeof import('./pages/GMail.js');
type MailSlurp = import('@codeceptjs/mailslurp-helper');

declare namespace CodeceptJS {
  interface SupportObject { I: I, current: any, Я: Я, VK_auth: VK_auth, GMail_auth: GMail_auth }
